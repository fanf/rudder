...
object NodeApi       extends ApiModuleProvider[NodeApi]    {
  ...
  final case object NodeGlobalScore extends NodeApi with GeneralApi with OneParam with StartsAtVersion11 with SortIndex {
    val z                      = implicitly[Line].value
  ...
  final case object NodeScoreDetails        extends NodeApi with GeneralApi with OneParam with StartsAtVersion11 with SortIndex {
    val z                      = implicitly[Line].value
  ...
  /*
  final case object NodeScoreDetail extends NodeApi with GeneralApi with TwoParam with StartsAtVersion11 with SortIndex {
    val z = implicitly[Line].value
