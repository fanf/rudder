...
object RudderLDAPConstants extends Loggable {
  ...
  val A_SERIALIZED_HEARTBEAT_RUN_FREQUENCY = "serializedHeartbeatRunFrequency"
  ...
  OC += (OC_RUDDER_NODE,
    ...
    may = Set(A_DESCRIPTION, A_SERIALIZED_AGENT_RUN_INTERVAL, A_SERIALIZED_HEARTBEAT_RUN_FREQUENCY))
