...
class ChangeRequestAPIHeaderVersion (
    restExtractor : RestExtractorService
  , apiV3         : ChangeRequestAPIService3
) extends RestHelper with Loggable{

  private[this] implicit val availableVersions = List(3)
  ...
  val requestDispatch : PartialFunction[Req, () => Box[LiftResponse]] = {
    ...
    case Get(Nil | List(""),req) =>
      ApiVersion.fromRequest(req) match {
        ...
        case _ => notValidVersionResponse("listChangeRequests")
      }
        ...
        case Full(ApiVersion(3)) =>
          restExtractor.extractChangeRequestInfo(req.params) match {
            ...
            case eb : EmptyBox =>
              ...
              val message=  s"Could not update ChangeRequest ${id} details cause is: ${fail.msg}."
  ...
  serve( "api" / "changeRequests" prefix requestDispatch)
